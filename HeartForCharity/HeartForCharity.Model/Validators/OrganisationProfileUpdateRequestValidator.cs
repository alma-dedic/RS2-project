...
{
    public class OrganisationProfileUpdateRequestValidator : AbstractValidator<OrganisationProfileUpdateRequest>
    {
        public OrganisationProfileUpdateRequestValidator()
        {
            RuleFor(x => x.Name)
